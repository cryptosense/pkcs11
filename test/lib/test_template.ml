...
let test_hash_template _ctx =
  ...
  assert_equal ~cmp:[%eq: string] ~printer:[%show: string]
    "55aa7ba6c64a5147b8c98e17a8289bb2" hex_hash;
  let rev_hash = P11.Template.hash rev_template in
  let hex_rev_hash = Digest.to_hex rev_hash in
  assert_equal ~cmp:[%eq: string] ~printer:[%show: string]
    "55aa7ba6c64a5147b8c98e17a8289bb2" hex_rev_hash

let suite = "p11_template" >::: ["test_hash_template" >:: test_hash_template]
