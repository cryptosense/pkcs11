...
let rec log:
  ...
  fun fmt ~footer ->
    function
      | Ctypes_static.Returns ty ->   assert false
...
let log:
  type a. Format.formatter ->
  header:string ->
  footer:string ->
  a fn ->
  a ->
  a  =
  fun fmt ~header ~footer ->
    function
...
sig
  ...
  val c_GetSlotList : CK_BYTE.t -> CK_SLOT_ID.t ptr -> CK_ULONG.t ptr ->
    CK_RV.t
  val c_GetSlotInfo : CK_SLOT_ID.t -> CK_SLOT_INFO.t ptr -> CK_RV.t
  val c_GetMechanismList : CK_SLOT_ID.t -> CK_MECHANISM_TYPE.t ptr ->
    CK_ULONG.t ptr -> CK_RV.t
  val c_GetMechanismInfo :
    CK_SLOT_ID.t -> CK_MECHANISM_TYPE.t -> CK_MECHANISM_INFO.t ptr -> CK_RV.t
  val c_InitToken : CK_SLOT_ID.t -> CK_UTF8CHAR.t ptr -> CK_ULONG.t -> CK_UTF8CHAR.t ptr -> CK_RV.t
  val c_InitPIN : CK_SESSION_HANDLE.t -> CK_UTF8CHAR.t ptr -> CK_ULONG.t -> CK_RV.t
  val c_SetPIN :
    CK_SESSION_HANDLE.t ->
    CK_UTF8CHAR.t ptr -> CK_ULONG.t -> CK_UTF8CHAR.t ptr -> CK_ULONG.t -> CK_RV.t
  val c_OpenSession :
    CK_SLOT_ID.t ->
    CK_FLAGS.t ->
    CK_VOID.t ptr ->
    CK_NOTIFY.t -> CK_SESSION_HANDLE.t ptr -> CK_RV.t
  val c_CloseSession : CK_SESSION_HANDLE.t -> CK_RV.t
  val c_CloseAllSessions : CK_SLOT_ID.t -> CK_RV.t
  val c_GetSessionInfo :
    CK_SESSION_HANDLE.t -> CK_SESSION_INFO.t ptr -> CK_RV.t

  val c_GetOperationState : CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t
  val c_SetOperationState :
    CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t ->
    CK_OBJECT_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_Login :
    CK_SESSION_HANDLE.t -> CK_USER_TYPE.t -> CK_UTF8CHAR.t ptr -> CK_ULONG.t -> CK_RV.t
  val c_Logout : CK_SESSION_HANDLE.t -> CK_RV.t
  val c_CreateObject :
    CK_SESSION_HANDLE.t ->
    CK_ATTRIBUTE.t ptr ->
    CK_ULONG.t -> CK_OBJECT_HANDLE.t ptr -> CK_RV.t
  val c_CopyObject :
    CK_SESSION_HANDLE.t ->
    CK_OBJECT_HANDLE.t ->
    CK_ATTRIBUTE.t ptr ->
  ...
  val c_GetObjectSize : CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_ULONG.t ptr -> CK_RV.t
  val c_GetAttributeValue :
    CK_SESSION_HANDLE.t ->
    CK_OBJECT_HANDLE.t ->
    CK_ATTRIBUTE.t ptr -> CK_ULONG.t -> CK_RV.t
  ...
  val c_FindObjects :
    ...
    CK_ULONG.t -> CK_ULONG.t ptr -> CK_RV.t
  ...
  val c_Encrypt :
    ...
    CK_BYTE.t ptr ->
    CK_ULONG.t ->
    CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t
  val c_EncryptUpdate :
    CK_SESSION_HANDLE.t ->
    CK_BYTE.t ptr ->
    CK_ULONG.t ->
  ...
  val c_DecryptUpdate :
    ...
    CK_ULONG.t ->
    CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t
  val c_DecryptFinal : CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t


  val c_DigestInit :
    CK_SESSION_HANDLE.t -> CK_MECHANISM.t ptr -> CK_RV.t
  val c_Digest :
    CK_SESSION_HANDLE.t ->
    CK_BYTE.t ptr ->
    CK_ULONG.t ->
  ...
  val c_DigestUpdate :
    ...
    CK_ULONG.t -> CK_RV.t
  val c_DigestKey :
    CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_DigestFinal : CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t
  ...
  val c_Verify :
    CK_SESSION_HANDLE.t ->
    CK_BYTE.t ptr ->
    CK_ULONG.t -> CK_BYTE.t ptr -> CK_ULONG.t -> CK_RV.t
  val c_VerifyUpdate :
    CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t -> CK_RV.t
  val c_VerifyFinal :
    CK_SESSION_HANDLE.t -> CK_BYTE.t ptr -> CK_ULONG.t -> CK_RV.t
  ...
  val c_VerifyRecover :
    CK_SESSION_HANDLE.t ->
    CK_BYTE.t ptr ->
    CK_ULONG.t -> CK_BYTE.t ptr -> CK_ULONG.t ptr -> CK_RV.t
  ...
  val c_GenerateKeyPair :
    ...
    CK_ATTRIBUTE.t ptr ->
    CK_ULONG.t ->
    CK_OBJECT_HANDLE.t ptr -> CK_OBJECT_HANDLE.t ptr -> CK_RV.t
  ...
  val c_WaitForSlotEvent : CK_FLAGS.t -> CK_SLOT_ID.t ptr -> CK_VOID.t ptr -> CK_RV.t
end
...
module Raw(D : sig
  ...
  let c_GetTokenInfo = declare "C_GetTokenInfo" S.c_GetTokenInfo CK.T.c_GetTokenInfo
  ...
  let c_GetMechanismList = declare "C_GetMechanismList" S.c_GetMechanismList CK.T.c_GetMechanismList

  let c_GetMechanismInfo = declare "C_GetMechanismInfo" S.c_GetMechanismInfo CK.T.c_GetMechanismInfo
...
(******************************************************************************)
  ...
  let c_CloseSession  = declare "C_CloseSession" S.c_CloseSession CK.T.c_CloseSession

  let c_CloseAllSessions  = declare "C_CloseAllSessions" S.c_CloseAllSessions CK.T.c_CloseAllSessions

  let c_GetSessionInfo  = declare "C_GetSessionInfo" S.c_GetSessionInfo CK.T.c_GetSessionInfo
  let c_GetOperationState = declare "C_GetOperationState" S.c_GetOperationState CK.T.c_GetOperationState
  let c_SetOperationState = declare "C_SetOperationState" S.c_SetOperationState CK.T.c_SetOperationState
...
(******************************************************************************)
  ...
  let c_CreateObject = declare "C_CreateObject" S.c_CreateObject CK.T.c_CreateObject

  let c_CopyObject = declare "C_CopyObject" S.c_CopyObject CK.T.c_CopyObject

  let c_DestroyObject = declare "C_DestroyObject" S.c_DestroyObject CK.T.c_DestroyObject

  let c_GetObjectSize = declare "C_GetObjectSize" S.c_GetObjectSize CK.T.c_GetObjectSize

  let c_GetAttributeValue = declare "C_GetAttributeValue" S.c_GetAttributeValue CK.T.c_GetAttributeValue

  let c_SetAttributeValue = declare "C_SetAttributeValue" S.c_SetAttributeValue CK.T.c_SetAttributeValue

  let c_FindObjectsInit = declare "C_FindObjectsInit" S.c_FindObjectsInit CK.T.c_FindObjectsInit

  let c_FindObjects = declare "C_FindObjects" S.c_FindObjects CK.T.c_FindObjects

  let c_FindObjectsFinal = declare "C_FindObjectsFinal" S.c_FindObjectsFinal CK.T.c_FindObjectsFinal
...
(******************************************************************************)
  ...
  let c_EncryptUpdate = declare "C_EncryptUpdate" S.c_EncryptUpdate CK.T.c_EncryptUpdate

  let c_EncryptFinal = declare "C_EncryptFinal" S.c_EncryptFinal CK.T.c_EncryptFinal
  ...
  let c_DecryptUpdate = declare "C_DecryptUpdate" S.c_DecryptUpdate CK.T.c_DecryptUpdate
  let c_DecryptFinal = declare "C_DecryptFinal" S.c_DecryptFinal CK.T.c_DecryptFinal
...
(******************************************************************************)
  ...
  let c_DigestUpdate = declare "C_DigestUpdate" S.c_DigestUpdate CK.T.c_DigestUpdate
...
(******************************************************************************)
  ...
  let c_SignRecoverInit = declare "C_SignRecoverInit" S.c_SignRecoverInit CK.T.c_SignRecoverInit
  ...
  let c_VerifyUpdate = declare "C_VerifyUpdate" S.c_VerifyUpdate CK.T.c_VerifyUpdate

  let c_VerifyFinal = declare "C_VerifyFinal" S.c_VerifyFinal CK.T.c_VerifyFinal

  let c_VerifyRecoverInit = declare "C_VerifyRecoverInit" S.c_VerifyRecoverInit CK.T.c_VerifyRecoverInit

  let c_VerifyRecover = declare "C_VerifyRecover" S.c_VerifyRecover CK.T.c_VerifyRecover

  let c_DigestEncryptUpdate = declare "C_DigestEncryptUpdate" S.c_DigestEncryptUpdate CK.T.c_DigestEncryptUpdate

  let c_DecryptDigestUpdate = declare "C_DecryptDigestUpdate" S.c_DecryptDigestUpdate CK.T.c_DecryptDigestUpdate

  let c_SignEncryptUpdate = declare "C_SignEncryptUpdate" S.c_SignEncryptUpdate CK.T.c_SignEncryptUpdate

  let c_DecryptVerifyUpdate = declare "C_DecryptVerifyUpdate" S.c_DecryptVerifyUpdate CK.T.c_DecryptVerifyUpdate
...
(******************************************************************************)
  ...
  let c_GenerateKeyPair = declare "C_GenerateKeyPair" S.c_GenerateKeyPair CK.T.c_GenerateKeyPair
  ...
  let c_GenerateRandom = declare "C_GenerateRandom" S.c_GenerateRandom CK.T.c_GenerateRandom
  let c_GetFunctionStatus = declare "C_GetFunctionStatus" S.c_GetFunctionStatus CK.T.c_GetFunctionStatus
  let c_CancelFunction = declare "C_CancelFunction" S.c_CancelFunction CK.T.c_CancelFunction
  let c_WaitForSlotEvent = declare "C_WaitForSlotEvent" S.c_WaitForSlotEvent CK.T.c_WaitForSlotEvent
end
...
struct
  ...
  let declare = fun name field typ ->
    let f =
      try
        ...
        else getf (Lazy.force function_list) field
      with
        | Sys.Break as break ->
            raise break
        | exn ->
  ...
  struct
    let declare (name: string)
        ...
        (typ: ('a -> 'b) Ctypes.fn) = declare name field typ
    let c_GetFunctionList = c_GetFunctionList
  end
...
module Fake (X : sig end): RAW = struct
  ...
  let return v  =
    let rec return : type a. a fn -> a = function
      | Ctypes_static.Returns ty -> Obj.magic v
...
sig
  ...
  val c_SetPIN : CK_SESSION_HANDLE.t -> oldpin:string -> newpin:string ->
    CK_RV.t
  val c_OpenSession : slot: CK_SLOT_ID.t -> flags: CK_FLAGS.t ->
  ...
  val c_Logout : CK_SESSION_HANDLE.t -> CK_RV.t
  val c_CreateObject : CK_SESSION_HANDLE.t -> Template.t ->
    CK_RV.t * CK_OBJECT_HANDLE.t
  val c_CopyObject :
    CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> Template.t ->
    CK_RV.t * CK_OBJECT_HANDLE.t
  val c_DestroyObject : CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t
  (* val c_GetObjectSize *)
  val c_GetAttributeValue : CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t ->
    Template.t -> CK_RV.t
  val c_SetAttributeValue : CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t ->
    Template.t -> CK_RV.t
  ...
  val c_FindObjectsFinal : CK_SESSION_HANDLE.t -> CK_RV.t
  val c_EncryptInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  ...
  val c_DecryptInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  ...
  val c_SignInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  ...
  val c_SignRecoverInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_SignRecover : CK_SESSION_HANDLE.t -> src: Data.t -> tgt: Data.t ->
    CK_RV.t

  val c_VerifyInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_Verify : CK_SESSION_HANDLE.t -> signed: Data.t -> signature: Data.t ->
    CK_RV.t
  val c_VerifyUpdate : CK_SESSION_HANDLE.t -> Data.t -> CK_RV.t
  val c_VerifyFinal : CK_SESSION_HANDLE.t -> Data.t -> CK_RV.t
  val c_VerifyRecoverInit : CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_VerifyRecover :
  ...
  val c_GenerateKey :
    CK_SESSION_HANDLE.t -> CK_MECHANISM.t -> Template.t ->
    CK_RV.t * CK_OBJECT_HANDLE.t
...
struct
  ...
  let c_GetSlotList: bool -> Slot_list.t -> CK_RV.t =
    ...
    fun tokenPresent slot_list ->
      let tp = CK_BYTE.(if tokenPresent then one else zero) in
      f
        tp
...
(******************************************************************************)
  ...
  let c_OpenSession : slot: CK_SLOT_ID.t -> flags: CK_FLAGS.t ->
    CK_RV.t * CK_SESSION_HANDLE.t =
    let f = F.c_OpenSession in
    fun ~slot ~flags ->
      let hSession = Ctypes.allocate ck_session_handle Unsigned.ULong.zero in
      let rv = f slot flags Ctypes.null Ctypes.(from_voidp CK_NOTIFY.u null) hSession in
      rv, Ctypes.(!@ hSession)
  ...
  let c_Logout: CK_SESSION_HANDLE.t -> CK_RV.t =
    F.c_Logout
...
(******************************************************************************)
  ...
  let c_CreateObject: CK_SESSION_HANDLE.t -> template ->
    CK_RV.t * CK_OBJECT_HANDLE.t =
  ...
  let c_CopyObject: CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> template ->
    CK_RV.t * CK_OBJECT_HANDLE.t =
  ...
  let c_GetAttributeValue: CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t ->
    template -> CK_RV.t =
  ...
  let c_SetAttributeValue: CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t ->
    template -> CK_RV.t =
  ...
  let c_FindObjects: CK_SESSION_HANDLE.t -> max_size:int ->
    CK_RV.t * CK_OBJECT_HANDLE.t list =
  ...
  let c_FindObjectsFinal: CK_SESSION_HANDLE.t -> CK_RV.t =
...
(******************************************************************************)
  ...
  let c_EncryptInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
  ...
  let c_Encrypt: CK_SESSION_HANDLE.t -> src: Data.t -> tgt: Data.t -> CK_RV.t =
    ...
    fun hSession ~src ~tgt ->
      f
        hSession
        (Data.get_content src)
        (Data.get_length src)
        (Data.get_content tgt)
        (Data.get_length_addr tgt)
  ...
  let c_DecryptInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
...
(******************************************************************************)
  ...
  let c_SignInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
  ...
  let c_SignUpdate: CK_SESSION_HANDLE.t -> Data.t -> CK_RV.t =
    ...
    fun hSession part ->
      f hSession
        (Data.get_content part)
        (Data.get_length part)
  ...
  let c_SignFinal: CK_SESSION_HANDLE.t -> Data.t -> CK_RV.t =
    ...
    fun hSession signature ->
      f
        ...
        (Data.get_length_addr signature)

  let c_SignRecoverInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
  ...
  let c_SignRecover: CK_SESSION_HANDLE.t -> src: Data.t -> tgt: Data.t ->
    CK_RV.t =
  ...
  let c_VerifyInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
  ...
  let c_Verify: CK_SESSION_HANDLE.t -> signed: Data.t -> signature: Data.t ->
    CK_RV.t =
    let f = F.c_Verify in
  ...
  let c_VerifyRecoverInit: CK_SESSION_HANDLE.t -> CK_MECHANISM.t ->
    CK_OBJECT_HANDLE.t -> CK_RV.t =
...
(******************************************************************************)
  ...
  let c_GenerateKey: CK_SESSION_HANDLE.t -> CK_MECHANISM.t -> Template.t ->
    CK_RV.t * CK_OBJECT_HANDLE.t =
  ...
  let c_DeriveKey :
    ...
    fun hSession mechanism hObject template ->
      ...
      let lTemplate = Ctypes.CArray.length template |> Unsigned.ULong.of_int in
      let hObject' =
        Ctypes.allocate ck_object_handle Unsigned.ULong.zero
      in
      let rv =
        f
          hSession
...
let load_driver ?log_calls ?on_unknown ?(load_mode=P11.Load_mode.auto) filename =
  begin
