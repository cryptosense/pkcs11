...
module CK_PKCS5_PBKD2_DATA_PARAMS = Pkcs11_CK_PKCS5_PBKD2_DATA_PARAMS 
  ...
  sig
    module T :
      sig
        ...
        val c_GetSlotList :
          (CK_BBOOL.t ->
           CK_SLOT_ID.t Ctypes.ptr -> Unsigned.ulong Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_GetSlotInfo :
        ...
        val c_GetMechanismList :
          (CK_SLOT_ID.t ->
           ...
           Unsigned.ulong Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_GetMechanismInfo :
          (CK_SLOT_ID.t ->
           CK_MECHANISM_TYPE.t -> CK_MECHANISM_INFO.t Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_InitToken :
          (CK_SLOT_ID.t ->  CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_UTF8CHAR.t Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_InitPIN :
          (CK_SESSION_HANDLE.t -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t)
          Ctypes.fn
        val c_SetPIN :
          (CK_SESSION_HANDLE.t ->
           CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t)
          Ctypes.fn
        val c_OpenSession :
          (CK_SLOT_ID.t ->
           CK_FLAGS.t ->
           unit Ctypes.ptr ->
           CK_NOTIFY.u Ctypes.ptr -> CK_SESSION_HANDLE.t Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        ...
        val c_GetOperationState :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        ...
        val c_Login :
          (CK_SESSION_HANDLE.t ->
           CK_USER_TYPE.t -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t)
          Ctypes.fn
        val c_Logout : (CK_SESSION_HANDLE.t -> CK_RV.t) Ctypes.fn
        val c_CreateObject :
          (CK_SESSION_HANDLE.t ->
           CK_ATTRIBUTE.t  Ctypes.ptr ->
           Unsigned.ulong -> CK_OBJECT_HANDLE.t Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_CopyObject :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t ->
        ...
        val c_GetObjectSize :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t -> Unsigned.ulong Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_GetAttributeValue :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t ->
           CK_ATTRIBUTE.t  Ctypes.ptr ->
           Unsigned.ulong -> CK_RV.t)
          Ctypes.fn
        ...
        val c_FindObjects :
          (CK_SESSION_HANDLE.t ->
           ...
           Unsigned.ulong -> Unsigned.ulong Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_FindObjectsFinal : (CK_SESSION_HANDLE.t -> CK_RV.t) Ctypes.fn
        val c_EncryptInit :
          (CK_SESSION_HANDLE.t ->
           CK_MECHANISM.t Ctypes.ptr -> CK_OBJECT_HANDLE.t -> CK_RV.t)
          Ctypes.fn
        val c_Encrypt :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr ->
        ...
        val c_DigestUpdate :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong -> CK_RV.t)
          Ctypes.fn
        val c_DigestKey :
          (CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t) Ctypes.fn
        val c_DigestFinal :
        ...
        val c_GenerateKeyPair :
          (CK_SESSION_HANDLE.t ->
           ...
           Unsigned.ulong ->
           CK_OBJECT_HANDLE.t Ctypes.ptr ->
           CK_OBJECT_HANDLE.t Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
        val c_WrapKey :
          (CK_SESSION_HANDLE.t ->
           CK_MECHANISM.t Ctypes.ptr ->
        ...
        val c_WaitForSlotEvent :
          (CK_FLAGS.t ->
           CK_SLOT_ID.t Ctypes.ptr -> unit Ctypes.ptr -> CK_RV.t)
          Ctypes.fn
      end
    module Function_list :
      sig
        ...
        val version :
          ...
          Ctypes.field
        val c_Initialize :
          (unit Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_Finalize :
          (unit Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetInfo :
          (CK_INFO.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetFunction_list :
          (ck_function_list Ctypes.ptr Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetSlotList :
          (CK_BBOOL.t ->
           CK_SLOT_ID.t Ctypes.ptr -> Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetSlotInfo :
          (CK_SLOT_ID.t -> CK_SLOT_INFO.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetTokenInfo :
          (CK_SLOT_ID.t -> CK_TOKEN_INFO.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetMechanismList :
          (CK_SLOT_ID.t ->
           CK_MECHANISM_TYPE.t Ctypes.ptr ->
           Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetMechanismInfo :
          (CK_SLOT_ID.t ->
           CK_MECHANISM_TYPE.t -> CK_MECHANISM_INFO.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_InitToken :
          (CK_SLOT_ID.t -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_UTF8CHAR.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_InitPIN :
          (CK_SESSION_HANDLE.t -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_SetPIN :
          (CK_SESSION_HANDLE.t ->
           CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_OpenSession :
          (CK_SLOT_ID.t ->
           CK_FLAGS.t ->
           unit Ctypes.ptr ->
           CK_NOTIFY.t -> CK_SESSION_HANDLE.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_CloseSession :
          (CK_SESSION_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_CloseAllSessions :
          (CK_SLOT_ID.t -> CK_RV.t, t)
          Ctypes.field
        val c_GetSessionInfo :
          (CK_SESSION_HANDLE.t -> CK_SESSION_INFO.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetOperationState :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_SetOperationState :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr ->
           Unsigned.ulong ->
           CK_OBJECT_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_Login :
          (CK_SESSION_HANDLE.t ->
           CK_USER_TYPE.t -> CK_UTF8CHAR.t Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_Logout :
          (CK_SESSION_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_CreateObject :
          (CK_SESSION_HANDLE.t ->
           CK_ATTRIBUTE.t  Ctypes.ptr ->
           Unsigned.ulong -> CK_OBJECT_HANDLE.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_CopyObject :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t ->
          ...
          Ctypes.field
        val c_DestroyObject :
          (CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_GetObjectSize :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t -> Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_GetAttributeValue :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t ->
           CK_ATTRIBUTE.t  Ctypes.ptr ->
           Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_SetAttributeValue :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t ->
        ...
        val c_FindObjects :
          (CK_SESSION_HANDLE.t ->
           CK_OBJECT_HANDLE.t Ctypes.ptr ->
           Unsigned.ulong -> Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_FindObjectsFinal :
          (CK_SESSION_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_EncryptInit :
          (CK_SESSION_HANDLE.t ->
           CK_MECHANISM.t Ctypes.ptr -> CK_OBJECT_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_Encrypt :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr ->
        ...
        val c_DecryptFinal :
          ...
          Ctypes.field
        val c_DigestInit :
          (CK_SESSION_HANDLE.t -> CK_MECHANISM.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_Digest :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr ->
        ...
        val c_DigestUpdate :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_DigestKey :
          (CK_SESSION_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        ...
        val c_Sign :
          ...
          Ctypes.field
        val c_SignUpdate :
          (CK_SESSION_HANDLE.t -> char Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_SignFinal :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong Ctypes.ptr -> CK_RV.t, t)
        ...
        val c_GenerateKeyPair :
          (CK_SESSION_HANDLE.t ->
           ...
           Unsigned.ulong ->
           CK_OBJECT_HANDLE.t Ctypes.ptr ->
           CK_OBJECT_HANDLE.t Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
        val c_WrapKey :
          (CK_SESSION_HANDLE.t ->
           CK_MECHANISM.t Ctypes.ptr ->
        ...
        val c_GenerateRandom :
          (CK_SESSION_HANDLE.t ->
           char Ctypes.ptr -> Unsigned.ulong -> CK_RV.t, t)
          Ctypes.field
        val c_GetFunctionStatus :
          (CK_SESSION_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_CancelFunction :
          (CK_SESSION_HANDLE.t -> CK_RV.t, t)
          Ctypes.field
        val c_WaitForSlotEvent :
          (CK_FLAGS.t ->
           CK_SLOT_ID.t Ctypes.ptr -> unit Ctypes.ptr -> CK_RV.t, t)
          Ctypes.field
      end
  end
...
sig
  ...
  val c_GetSlotList : CK_BBOOL.t -> CK_SLOT_ID.t ptr -> CK_ULONG.t ptr ->
    CK_RV.t
  ...
  val c_SetPIN :
    CK_SESSION_HANDLE.t ->
    CK_UTF8CHAR.t Ctypes.ptr -> CK_ULONG.t -> CK_UTF8CHAR.t Ctypes.ptr -> CK_ULONG.t -> CK_RV.t
  val c_OpenSession :
    CK_SLOT_ID.t ->
    CK_FLAGS.t ->
    CK_VOID.t ptr ->
  ...
  val c_SetOperationState :
    ...
    CK_OBJECT_HANDLE.t -> CK_OBJECT_HANDLE.t -> CK_RV.t
  val c_Login :
    CK_SESSION_HANDLE.t -> CK_USER_TYPE.t -> CK_UTF8CHAR.t Ctypes.ptr -> CK_ULONG.t -> CK_RV.t
