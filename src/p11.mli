...
sig
  ...
  (** [key_type t] returns the type of keys generated by the mechanism
      [t]. [t] must be a key-generating mechanism, otherwise the
      exception [Undefined_key_type] is raised.  *)
